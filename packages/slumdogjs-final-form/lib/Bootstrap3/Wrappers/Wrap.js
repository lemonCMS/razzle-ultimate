...
var Wrap = function (_React$Component) {
  ...
  (0, _createClass3.default)(Wrap, [{
    ...
    value: function dropdownButton(props, isStatic) {
      ...
      var size = (0, _get3.default)(props.field, 'bsSize', this.props.size);
      ...
      if (isStatic === true || disabled === true) {
        return _react2.default.createElement(
          ...
          null,
          dropDownTitle || (0, _get3.default)(props.field, 'placeholder')
        );
      }
    ...
    value: function renderField(props) {
      ...
      var input = props.input,
          ...
          custom = (0, _objectWithoutProperties3.default)(props, ['input', 'help', 'meta']);
