...
import PersistServer from '../../slumdogjs-persist-component/src/PersistServer';
import PersistComponent from '../../slumdogjs-persist-component/src/PersistComponent';
import {
  saveAndRestoreCookie,
  saveAndRestoreLocal,
} from './redux/store/counter';
import initializeStore from './redux/store';
import client, {trigger} from '../../slumdogjs-core/src/client';
